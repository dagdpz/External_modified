function [data] = SEV2mat_working(SEV_DIR, varargin)
...
if any(CHANNELS~=0)
    file_list=file_list(ismember([file_list.chan],CHANNELS));
end
    ...
    for ii = 1:numRanges
        ...
        for jj = loop
            ...
            for kk = minHourOffset(ii):maxHourOffset(ii)
                ...
                %% ind indicates channel? then it should be outside of this loop!
                %  ind = ind + 1;
            end
